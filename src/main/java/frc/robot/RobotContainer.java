...
public class RobotContainer {
    ...
    */
    ...
    private void configureButtonBindings() {
        ...
        up.whileHeld(new IncreaseBigFlywheel(m_shooter), true);

        final POVButton down = new POVButton(xboxController, 180);
        down.whileHeld(new DecreaseBigFlywheel(m_shooter), true);

        final POVButton left = new POVButton(xboxController, 90);
        left.whileHeld(new DecreaseSmallFlywheel(m_shooter), true);

        final POVButton right = new POVButton(xboxController, 270);
        right.whileHeld(new IncreaseSmallFlywheel(m_shooter), true);
